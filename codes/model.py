...
class KGEModel(nn.Module):
    def __init__(self, model_name, nentity, nrelation, hidden_dim, gamma, 
        ...
        if model_name not in ['TransE', 'DistMult', 'ComplEx', 'RotatE', 'pRotatE', 'HRotatE', 'HTransE']:
    ...
    def HTransE(self, head, relation, tail, relation_inv, ht, th, mode):
        if mode == 'head-batch':
