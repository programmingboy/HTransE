# Best Configuration for HTransE
#
bash run.sh train HTransE FB15k 0 0 1024 128 1000 24.0 1.0 0.0001 150000 16
bash run.sh train HTransE wn18 0 0 1024 512 500 12.0 0.5 0.0005 80000 16
bash run.sh train HTransE YAGO3-10 0 0 1024 512 500 24.0 0.8 0.0002 100000 4
#
